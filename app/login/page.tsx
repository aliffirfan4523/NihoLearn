      ...
      <div className="w-full max-w-md">
        <div className="rounded-3xl border border-black/10 bg-white p-8 shadow-sm dark:border-white/20 dark:bg-[#1A1A1A]">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-3xl font-bold tracking-tight text-[#1A1A1A] dark:text-[#FAFAFA]">Welcome back</h1>
            <p className="mt-2 text-[#6B6B6B] dark:text-[#A0A0A0]">Sign in to continue your Japanese learning journey.</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-[#6B6B6B] dark:text-[#A0A0A0]">
            ...
            <Link href="/signup" className="font-semibold text-[#C84B31] hover:underline dark:text-[#E85C40]">
              Sign up
            </Link>
          </p>
        </div>
